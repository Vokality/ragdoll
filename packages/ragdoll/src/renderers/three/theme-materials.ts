...
export function createThemeMaterials(theme: RagdollTheme): CharacterMaterials {
  const materials = {
    skin: standard({ roughness: 0.42, metalness: 0.04 }),
    skinLight: standard({
      roughness: 0.34,
      metalness: 0.04,
      transparent: true,
    ...
    skinFace: standard({ roughness: 0.38, metalness: 0.04 }),
    hair: standard({ roughness: 0.58, metalness: 0.06 }),
    hairLight: standard({
      roughness: 0.42,
      metalness: 0.06,
      transparent: true,
    ...
    brow: standard({ roughness: 0.62, metalness: 0.05 }),
    sclera: standard({ roughness: 0.16, metalness: 0.04 }),
    iris: standard({ roughness: 0.12, metalness: 0.18 }),
    pupil: standard({ roughness: 0.08, metalness: 0.02 }),
    highlight: standard({
      roughness: 0.12,
      metalness: 0,
      transparent: true,
    ...
    lid: standard({ roughness: 0.48, metalness: 0.03 }),
    upperLip: standard({ roughness: 0.28, metalness: 0.08 }),
    lowerLip: standard({ roughness: 0.24, metalness: 0.08 }),
    blush: standard({
      roughness: 0.7,
      metalness: 0,
      transparent: true,
    ...
    teeth: standard({ roughness: 0.28, metalness: 0.04 }),
    nose: standard({ roughness: 0.36, metalness: 0.04 }),
