  ...
  return (
    <div style={styles.container}>
      ...
      >
        ...
        <span style={styles.triggerValue}>{currentTheme.name.toUpperCase()}</span>
          ...
          <div style={styles.dropdown}>
            ...
            <div style={styles.dropdownContent}>
              {themes.map((theme, index) => (
                ...
                >
                  <span style={styles.optionIndex}>{(index + 1).toString().padStart(2, '0')}.</span>
                  <div
                    style={{
                      ...styles.optionSwatch,
                  ...
                  <span style={styles.optionName}>
                    {theme.id === currentThemeId ? '>' : ' '} {theme.name.toUpperCase()}
                  </span>
...
const styles = {
  ...
  dropdown: {
    ...
    zIndex: 1000,
    minWidth: '280px',
    boxShadow: '0 0 20px rgba(51, 255, 51, 0.2), inset 0 0 40px rgba(51, 255, 51, 0.03)',
    fontFamily: "var(--retro-font, 'VT323', monospace)",
    color: 'var(--retro-green, #33ff33)',
