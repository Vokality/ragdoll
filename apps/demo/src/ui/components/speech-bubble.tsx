...
> = {
  default: {
    ...
    boxShadow:
      "0 0 15px rgba(51, 255, 51, 0.3), inset 0 0 30px rgba(51, 255, 51, 0.05)",
  },
  whisper: {
    backgroundColor: "var(--retro-bg, #0a0a0a)",
  ...
  shout: {
    ...
    boxShadow:
      "0 0 25px rgba(255, 176, 0, 0.4), inset 0 0 30px rgba(255, 176, 0, 0.05)",
    ...
    >
      ...
      <div
        style={{
          ...
          color:
            tone === "shout"
              ? "var(--retro-amber, #ffb000)"
              : tone === "whisper"
                ? "var(--retro-green-dim, #1a8c1a)"
