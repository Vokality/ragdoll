...
Tell Lumen what to call you and share small preferences or routines you want it to remember. For example, “Call me Sam. I prefer short focus sessions.” The agent saves a local profile containing your name and up to eight short notes. Onboarding is a conversation, not a form; declining to share a name does not block any feature.
